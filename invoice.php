<?php
	...
	$pdf->Cell(150,10,iconv('UTF-8', 'ISO-8859-1',"Nombre de empresa"),0,0,'L');
	...
	$pdf->SetTextColor(39,39,51);
	$pdf->Cell(35,7,iconv('UTF-8', 'ISO-8859-1',"Factura Nro."),0,0,'C');
	...
	$pdf->SetFont('Arial','B',10);
	$pdf->SetTextColor(97,97,97);
	$pdf->Cell(35,7,iconv('UTF-8', 'ISO-8859-1',"1"),0,0,'C');
